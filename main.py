...
app.add_handler(CallbackQueryHandler(show_provinces, pattern=r"^admin_select_country_"))
app.add_handler(CallbackQueryHandler(show_pending_items, pattern=r"^admin_select_province_"))
app.add_handler(CallbackQueryHandler(review_item_details, pattern=r"^admin_review_item_"))
app.add_handler(CallbackQueryHandler(approve_item, pattern=r"^admin_approve_item_"))
app.add_handler(CallbackQueryHandler(reject_item, pattern=r"^admin_reject_item_"))
