...
def run_git_force_push():
    ...
    try:
        ...
        # پاک‌سازی فایل‌های نادیده گرفته‌شده (.venv، __pycache__، ...)
        ...
        # 🚀 push با اجبار کامل (نسخه لوکال قطعی جایگزین می‌شود)
        subprocess.run(["git", "push", "origin", GITHUB_BRANCH, "--force"], check=True)
        print("✅ تغییرات لوکال با موفقیت و به‌صورت کامل روی GitHub اعمال شدند.")
